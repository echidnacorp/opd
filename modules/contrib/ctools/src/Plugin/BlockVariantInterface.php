...
interface BlockVariantInterface extends VariantInterface {
  ...
  /**
   * Denotes that a block is being added to the variant.
   */
  CONST ADD_BLOCK = 'add.block';

  /**
   * Denotes that a block is being updated in the variant.
   */
  CONST UPDATE_BLOCK = 'update.block';

  /**
   * Denotes that a block is being deleted from the variant.
   */
