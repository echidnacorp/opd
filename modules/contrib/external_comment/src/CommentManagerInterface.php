...
interface CommentManagerInterface {
   ...
   */
  const EXTERNAL_COMMENT_MODE_FLAT = 0;

  /**
   * Comments are displayed as a threaded list - expanded.
   */
  const EXTERNAL_COMMENT_MODE_THREADED = 1;
   ...
   *
   * @param string $external_comment_type
   *   The comment bundle.
   */
  public function addBodyField($external_comment_type);
 ...
 /**
   ...
   *   The comment bundle.
   */
  public function addEntityField($external_comment_type);

  /**
   * Provides a message if posting comments is forbidden.
   *
   * If authenticated users can post external comments, a message is returned that
   ...
   *
   * @return string
   *   HTML for a "you can't post external comments" notice.
   */
