...
interface CommentStorageInterface extends ContentEntityStorageInterface {
   ...
   * @param int $external_comment_mode
   *   The comment display mode: CommentManagerInterface::EXTERNAL_COMMENT_MODE_FLAT or
   *   CommentManagerInterface::EXTERNAL_COMMENT_MODE_THREADED.
   * @param int $divisor
