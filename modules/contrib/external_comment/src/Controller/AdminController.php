...
class AdminController extends ControllerBase {
  ...
  public function adminPage(Request $request, $type = 'new') {
    if ($request->request->get('operation') == 'delete' && $request->request->get('external_comments')) {
      return $this->formBuilder->getForm('\Drupal\external_comment\Form\ConfirmDeleteMultiple', $request);
    }
    else {
      return $this->formBuilder->getForm('\Drupal\external_comment\Form\CommentAdminOverview', $type);
    }
  }
