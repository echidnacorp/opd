 ...
 *
 * @Action(
 *   id = "external_comment_unpublish_by_keyword_action",
...
class UnpublishByKeywordComment extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\Core\Entity\EntityViewBuilderInterface $external_comment_view_builder
   *   The comment entity builder handler.
   * @param \Drupal\Core\Render\RendererInterface $renderer
   *   The renderer.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityViewBuilderInterface $external_comment_view_builder, RendererInterface $renderer) {
    parent::__construct($configuration, $plugin_id, $plugin_definition);

    $this->viewBuilder = $external_comment_view_builder;
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('entity.manager')->getViewBuilder('external_comment'),
