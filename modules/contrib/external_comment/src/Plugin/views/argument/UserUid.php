...
namespace Drupal\external_comment\Plugin\views\argument;
 ...
 *
 * @ViewsArgument("argument_external_comment_user_uid")
 */
class UserUid extends ArgumentPluginBase {
  ...
  public function query($group_by = FALSE) {
    ...
    if ($this->table != 'external_comment_field_data') {
      ...
      $subselect = $this->database->select('external_comment_field_data', 'c');
