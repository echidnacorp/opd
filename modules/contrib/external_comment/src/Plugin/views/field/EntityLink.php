 ...
 *
 * @ViewsField("external_comment_entity_link")
 */
class EntityLink extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    return !empty($this->build[$entity->id()]['links']['external_comment__comment']) ? drupal_render($this->build[$entity->id()]['links']['external_comment__comment']) : '';
  }
