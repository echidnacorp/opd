 ...
 *
 * @ViewsField("external_comment_ces_last_external_comment_name")
 */
class StatisticsLastCommentName extends FieldPluginBase {
  ...
  public function query() {
    // last_external_comment_name only contains data if the user is anonymous. So we
    ...
    $definition = [
      ...
      'field' => 'uid',
      'left_table' => 'external_comment_entity_statistics',
      'left_field' => 'last_external_comment_uid',
      'extra' => [
        [
          'field' => 'uid',
          'operator' => '!=',
    ...
    $this->uid = $this->query->addField($this->tableAlias, 'last_external_comment_uid');
  }
