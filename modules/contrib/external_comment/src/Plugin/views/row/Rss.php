...
namespace Drupal\external_comment\Plugin\views\row;
 ...
 *
 * @ViewsRow(
 *   id = "external_comment_rss",
 *   title = @Translation("External Comment"),
 *   help = @Translation("Display the comment as RSS."),
 *   theme = "views_view_row_rss",
 *   register_theme = FALSE,
 *   base = {"external_comment_field_data"},
 *   display_types = {"feed"}
 * )
 */
class Rss extends RssPluginBase {
   ...
   * {@inheritdoc}
   */
  protected $base_table = 'external_comment_field_data';
   ...
   * {@inheritdoc}
   */
  protected $entityTypeId = 'external_comment';
  ...
  public function preRender($result) {
    ...
    $this->comments = $this->entityManager->getStorage('external_comment')->loadMultiple($cids);
  }
  ...
  public function render($row) {
    ...
    $build = $this->entityManager->getViewBuilder('external_comment')->view($comment, 'rss');
    unset($build['#theme']);
