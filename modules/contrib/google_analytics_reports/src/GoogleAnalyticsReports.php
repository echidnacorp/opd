...
/**
 * @file
 * Contains \Drupal\google_analytics_reports\GoogleAnalyticsReports.
 */
    ...
    if ($field['id'] == 'dimensionXX') {
      ...
      \Drupal::database()->insert('google_analytics_reports_fields')
        ->fields([
          ...
          'type' => 'dimension',
          'data_type' => 'string',
          'column_group' => 'Custom variables or Columns',
          'ui_name' => 'Custom Dimension 01',
